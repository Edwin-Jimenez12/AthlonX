      ...
      <section className="relative isolate flex min-h-[calc(100vh-92px)] items-center bg-cover bg-center px-6 py-16 md:px-14 lg:px-24" >
        <div className="mx-auto flex w-full max-w-7xl flex-col">
          <div className="max-w-2xl">
            ...
            <p className="mt-7 max-w-xl text-base leading-7 text-slate-300 md:text-lg">Organiza equipos, jugadores y partidos desde un solo lugar. Lleva el control de cada torneo y cada punto, de forma simple, rápida y profesional.</p>
