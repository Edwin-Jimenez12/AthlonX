...
type Team = { id: string; name: string; city: string | null; logo_url: string | null; organization_id: string | null; discipline_id: string | null; contact_email: string | null; contact_phone: string | null }
...
export default function TeamsPage() {
  ...
  async function loadTeams() {
    ...
    const { data, error } = await supabase.from('teams').select('id,name,city,logo_url,organization_id,discipline_id,contact_email,contact_phone').eq('organization_id', organizationId).order('name')
  ...
  async function saveTeam(event: FormEvent<HTMLFormElement>) {
    ...
    const values = { name: name.trim(), city: city.trim() || null, contact_email: contactEmail.trim() || null, contact_phone: contactPhone.trim() || null, organization_id: organizationId, discipline_id: disciplineId }
