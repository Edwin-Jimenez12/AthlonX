...
export default function TeamDashboard() {
  ...
  return <main className="min-h-screen bg-[#07131e] text-white lg:ml-64">
    <section className="mx-auto max-w-7xl px-5 py-8 sm:px-8 sm:py-12 lg:px-10">
      ...
      {team?.id && <div className="mt-8"><AffiliationRequestPanel sourceTeamId={team.id} title="Vincular integrantes al equipo" /></div>}
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-[1fr_310px]">
        <div className="space-y-6">
          ...
          <section id="plantilla" className="rounded-3xl border border-[#1f4057] bg-[#0b1d2c] p-6 sm:p-8"><div className="flex flex-wrap items-start justify-between gap-4"><div><p className="text-xs font-bold uppercase tracking-[.2em] text-[#b4ff45]">Gestión de personas</p><h3 className="mt-2 font-display text-3xl uppercase">Plantilla</h3><p className="mt-2 max-w-xl text-sm leading-6 text-slate-400">Aquí podrás organizar atletas, entrenadores y staff asociados al equipo.</p></div><Users className="text-[#b4ff45]" size={24} /></div><EmptyTeamState text="Todavía no hay integrantes registrados en este equipo." action="Buscar atletas" href="/dashboard/busqueda" /></section>
